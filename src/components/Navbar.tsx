...
import { Clock, Phone, Mail, Facebook, Instagram, Youtube, Linkedin, PhoneCallIcon } from "lucide-react";
    ...
    return (
        <div className="shadow-sm">
            <nav className="max-w-7xl mx-auto  sm:px-6 lg:px-8 ">
                ...
                <div className="py-[33px] flex justify-between items-center max-w-[1107px] mx-auto">
                    {/* Nav Links */}
                    <div className="flex space-x-[66px] text-lg">
                    ...
                    <div className="flex space-x-4">
                        {
                            SocialMediaIcon.map((item, idx) => (
                                <Link key={idx} href={item.href}>
                                    <div className="bg-black text-white p-2 rounded-full">{item.icon}</div>
                                </Link>
                            ))
                        }
                    </div>
