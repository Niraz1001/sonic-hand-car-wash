            ...
            <div className='p-0 pb-5  lg:p-5'>
                <div className='flex justify-center md:justify-start flex-col lg:flex-row items-center lg:items-start gap-5'>
                    ...
                    <div>
                        ...
                        <div className='w-full pl-20 md:pl-0 flex gap-2 justify-center lg:justify-start my-2 lg:my-0 text-[14px] lg:text-base'><FaQuoteLeft className='w-3 h-4 lg:w-6 lg:h-6 text-[#2291EA]' /> <p className=' text-[#444444] w-full'>{Item.title}</p></div>
