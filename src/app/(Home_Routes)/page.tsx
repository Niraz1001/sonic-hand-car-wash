...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      {/* Hero Section*/}
      <div className='w-screen h-[379.91px] relative'> {/* Set a fixed height */}
        <Image
          src={"/img/Bg.png"}
          alt='HeroSectionImg'
      ...
      <div className='bg-white mx-5 md:mx-5 lg:mx-12 p-5 rounded-md shadow-lg mt-[-25px] relative z-10'>
        <h1 className='text-[25px] md:text-[30px] lg:text-[48px] font-bold text-center mb-9'>It’s time to <span style={{ color: "#2291EA" }}>Shine.</span></h1>
        <div className='container max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 grid grid-cols-[55%_45%]'>
          ...
          <div>
            <div className='flex items-start gap-3 mb-5 text-[12px] md:text-[16px]'>
              <p><HelpCircleIcon size={20} color='black' className='mt-1' /></p>
              <div>
                ...
                <button className='bg-[#2291EA] px-10 py-2 rounded-lg mt-1 text-white'>Learn more →</button>
              </div>
            </div>
          </div>
      ...
      <div className='container max-w-7xl mx-auto px-5 md:px-8 lg:px-8 py-10 md:py-16 '>
        ...
        <div className='mt-16 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 lg:gap-8'>
          {
      ...
      <div className='max-w-7xl mx-auto px-5 md:px-8 lg:px-8 py-10 md:py-16 text-[12px] md:text-[16px]'>
        <div className='bg-white max-w-4xl mx-auto p-12 shadow-lg rounded-lg mt-5'>
          <h1 className='text-[25px] md:text-[32px] font-bold text-center'>JOIN OUR EXCLUSIVE SUBSCRIPTION PLAN!</h1>
          <p className='mt-5 text-center px-3 md:px-10 lg:px-20'>Enjoy premium car care services with our hassle-free monthly subscription. Get priority access, exclusive discounts, and up to 10 premium washes per month!</p>
                ...
                Exclusive.slice(0, 3).map((item, idx) => (
                  <div key={idx}>
                    <div className='flex justify-start gap-5'>
                      <div className='bg-[#2291EA] p-[1px] md:p-[2px] rounded-full w-fit h-fit'>{item.Icon}</div>
                      <div className='mt-[-5px] mb-5 pr-5'>
                        <p className='text-[14px] md:text-[18px] font-semibold'> {item.name}</p>
      ...
      <div className='max-w-7xl mx-auto px-5 md:px-8 lg:px-8 py-16'>
        ...
        <div className='mt-16 flex flex-col lg:flex-row gap-8 justify-center lg:justify-start items-center'>
        {
